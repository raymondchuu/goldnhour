        ...
        <div>
            <div className="about" style={{marginTop: '88px'}}>
                ...
                <div className="right-column-about">
                    ...
                    */}
                    <p style={{fontSize: '24px'}}>ILLUMINATE YOUR FEATURES AND FEEL TIMELESS</p>
            ...
            <div className="about-test-container">
                <p style={{fontSize: '24px', paddingBottom: '2%'}}>WHAT PEOPLE SAY</p>     
                ...
                <p style={{fontSize: '24px'}}><a href='/testimonials' target="_blank" className="home-view-all">VIEW ALL</a></p>
            </div>
            ...
            <div className="about-services">
                <p style={{fontSize: '24px', color: '#292929', textAlign: 'center'}}>OUR SERVICES</p>
                <div>
